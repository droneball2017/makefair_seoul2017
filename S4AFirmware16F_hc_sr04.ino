// NEW IN VERSION 1.6f (by JinWoo Park - jinwoo75.park@gmail.com):
// 1. add a short LOW pulse beforehand to ensure a clean HIGH pulse
// 2. add ULTRASONIC_SENSOR definition
//    : do not have to hold 2 firmware version
//    : just comment or uncomment the definition

// NEW IN VERSION 1.6e (by http://elprofegarcia.com/ ):
/*
...
// Sitio para descargar el programa en S4A que controla Ardu5: http://dinastiatecnologica.com/producto/ardu5/
...
//  delayMicroseconds(2);                 // give a short LOW pulse beforehand to ensure a clean HIGH pulse
  ...
  distancia1 = (170 * duracion) / 10000;  // calculo de la distancia en cm
